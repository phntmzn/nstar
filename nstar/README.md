...
`/Users/macbookair/Documents/mid`
...
2. generate one song
3. save a MIDI file into `/Users/macbookair/Documents/mid`
...
.venv/bin/python generation.py \
  --target 5 \
  --output-dir /Users/macbookair/Documents/mid \
  --producers 1
```
...
- copied checkpoint: `dist-macos/progression_model.pt` if the project already has one

The frozen executable uses `progression_model.pt` next to the executable as its default model path, so copying the checkpoint beside the binary lets it start without retraining.
...
- `--skip-model-copy`: build the binary without copying `progression_model.pt`
...
- MIDI output folder default: `/Users/macbookair/Documents/mid`
- Model checkpoint default: `progression_model.pt` next to the running script or executable
...
5. Check the generated MIDI files in `/Users/macbookair/Documents/mid`.
